...
if [ ${INPUT_REPO_NAME^^} == 'TRUE' ]; then
     /commit.sh ${INPUT_SOURCE-DIRECTORY} ${INPUT_DESTINATION-GITHUB-USERNAME}  ${INPUT_DESTINATION-REPOSITORY-NAME} ${INPUT_USER-EMAIL} ${INPUT_USER-NAME} ${INPUT_DESTINATION-REPOSITORY-USERNAME} ${INPUT_TARGET-BRANCH} ${INPUT_COMMIT-MESSAGE}
fi
