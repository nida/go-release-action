...
declare SOURCE_DIRECTORY=${INPUT_SOURCE-DIRECTORY}
declare DESTINATION_GITHUB_USERNAME=${INPUT_DESTINATION-GITHUB-USERNAME}
declare DESTINATION_REPOSITORY_NAME=${INPUT_DESTINATION-REPOSITORY-NAME}
declare USER_EMAIL=${INPUT_USER-EMAIL}
declare USER_NAME=${INPUT_USER-NAME}
declare DESTINATION_REPOSITORY_USERNAME=${INPUT_DESTINATION-REPOSITORY-USERNAME} 
declare TARGET_BRANCH=${INPUT_TARGET-BRANCH}
declare COMMIT_MESSAGE=${INPUT_COMMIT-MESSAGE}
