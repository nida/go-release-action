...
if [ ${INPUT_REPO_NAME} == 'TRUE' ]; then
     /commit.sh ${INPUT_SOURCE_DIRECTORY} ${INPUT_DESTINATION_GITHUB_USERNAME}  ${INPUT_DESTINATION_REPOSITORY_NAME} ${INPUT_USER_EMAIL} ${INPUT_USER_NAME} ${INPUT_DESTINATION_REPOSITORY_USERNAME} ${INPUT_TARGET_BRANCH} ${INPUT_COMMIT_MESSAGE}
fi
